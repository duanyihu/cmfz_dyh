    ...
    <script>
        $(function () {
           /* $("captchaImage").click(function () {
                $("captchaImage").prop('src',"/admin/code?"+new Date().getTime())
            })*/
            /*点击 切换验证码*/
            $("#captchaImage").click(function(){
            ...
            * */
                $.extend($.validator.message,{
                    ...
                    minlength:$.validator.format("<span style='color: red'>最少输入2个字符</span>")
                })
            /*
            *表单提交
            * */
                    ...
                    $.ajax({
                        ...
                        success:function(){
                            if(date.success==200){
                                ...
                                $("msgDiv").html("<span>"+data.message+"</sapan>");
                            }
                        }
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input  minlength="2" type="password" name="password" placeholder="请输入密码..." class="form-password form-control" required id="form-password">
                            </div>
                            <div class="form-group">
